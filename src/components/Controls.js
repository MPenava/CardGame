function Controls({onSortAsc, onSortDesc}) {
  ...
  return (
    <section className="border-2 border-solid border-white basis-2/5">
      ...
      <div className="my-8 ml-5 mr-5">
        <button className="w-full text-lg uppercase hover:bg-gray-500 text-white text-center py-1 border-2 border-thin border-white ">
          Submit
        </button>
      </div>
    </section>
